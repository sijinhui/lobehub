export default {
  ...
  'betterAuth.signin.continueWithPasskey': 'Continue with a passkey',
  ...
  'betterAuth.signin.passkeyError': 'Passkey sign in failed. Please try again.',
  ...
  'profile.passkey.added': 'Passkey added',
  'profile.passkey.addError': 'Could not add the passkey. Please try again.',
  'profile.passkey.defaultName': 'Passkey',
  'profile.passkey.delete': 'Delete passkey',
  'profile.passkey.deleted': 'Passkey deleted',
  'profile.passkey.deleteDescription': 'You will no longer be able to sign in with “{{name}}”.',
  'profile.passkey.deleteError': 'Could not delete the passkey. Please try again.',
  'profile.passkey.deleteTitle': 'Delete this passkey?',
